		...
		//This program will open this pages "https://mail.rediff.com/cgi-bin/login.cgi" and hit ok on Alert 
		...
		public class Selenium_ClickonOK_Alert { //name of this program is Selenium_ClickonOK_Alert_
			...
			public static void main(String[] args) {
				...
				browserObject.findElement(By.name("ok")).click();
